...
public class UserController {
    ...
    public ResultVO register(@RequestBody UserRegisterForm registerForm) {
        ...
        String redisCode = (String) redisTemplate.opsForValue().get("uushop-sms-code-" + mobile);
        if (!redisCode.equals(code)) throw new ShopException(ResponseEnum.CODE_ERROR.getMsg());
