      ...
      tableData:[
        {
          ...
          "stock": 107,
          "description": "好吃好吃",
          "icon": "https://m.360buyimg.com/mobilecms/s750x750_jfs/t1/171918/6/4940/300074/607aa8ebEf9702ba0/6cff9c166521d87c.jpg!q80.dpg.webp",
          "categoryName": "热销榜"
        }
      ],
      pageSize:5,
    ...
    submitForm() {
      ...
      if(_this.keyWord == ''){
        ...
        axios.get(this.$store.state.globalhost+'product-service/seller/product/like/1/'+_this.pageSize+'/'+_this.keyWord).then(function (resp) {
          _this.tableData = resp.data.data ? resp.data.data.content : []
          _this.pageSize = resp.data.data ? resp.data.data.size : 5
          _this.total = resp.data.data ? resp.data.data.total : 0
        })
      }
    },
    categoryForm() {
